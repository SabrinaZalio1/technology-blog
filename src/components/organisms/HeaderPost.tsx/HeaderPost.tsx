...
const HeaderPost: React.FC<HeaderPostProps> = ({ variant = DEFAULT_VARIANT, headerVariant = 'pill', post }) => {
    ...
    return (
        <HeaderPostContainer>
            ...
            <InfoContainer $variant={variant}>
                ...
                <Section>
                    <BtnLink to={`/news/${id}`} text='Read' arrowColor='#9C73F7' variant={variant}/>
